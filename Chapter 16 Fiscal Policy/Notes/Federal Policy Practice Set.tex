...
\title{Fiscal Policy: Practice Examples and Questions \\ Introduction to Macroeconomics}
...
\newpage
\begin{center}
\section*{Problem Set 1 with Examples}
\end{center}
\subsection*{Example 1}
\begin{questions}
\question Consider the examples presented in Figure 16.1 \\ \includegraphics[scale=0.3]{images/Figure 16.1.png} \\ Initially, the economy is in long-run equalibrium at point A, with $P = 100$, $Y=Y$* (full employment, and 
\end{questions}
\end{document}